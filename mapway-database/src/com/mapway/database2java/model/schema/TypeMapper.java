...
public class TypeMapper {
	...
	public String getPrimitive(String t) {
		...
		String[][] pri = { { "Boolean", "bool" }, { "String", "CString" },
				{ "Timestamp", "CTime" }, { "boolean", "bool" },
				{ "Byte", "byte" }, { "byte", "byte" },
				...
				{ "Void", "void" }, { "void", "void" }, { "Date", "CDate" } };
	...
	public TypeMapper() {
		 ...
		 * DATE "; TIME "; TIMESTAMP "; TIMESTAMPNS "; TIMESTAMPTZ ";
		 * TIMESTAMPLTZ "; INTERVALYM "; INTERVALDS "; BINARY "; VARBINARY ";
		 * LONGVARBINARY "; ROWID "; CURSOR "; BLOB "; CLOB "; BFILE "; STRUCT
		 * "; ARRAY "; REF "; OPAQUE "; JAVA_STRUCT "; JAVA_OBJECT ";
		 * PLSQL_INDEX_TABLE "; BINARY_FLOAT "; BINARY_DOUBLE "; NULL "; NUMBER
		 * "; RAW "; OTHER "; FIXED_CHAR "; DATALINK "; BOOLEAN ";
		 */
		mt3 = new ModleTypes();
