...
public class TypeMapper {
  ...
  public String getPrimitive(String t) {
    ...
    String[][] pri =
        { {"Boolean", "bool"}, {"String", "CString"}, {"Timestamp", "CTime"}, {"boolean", "bool"},
            {"Byte", "byte"}, {"byte", "byte"}, {"Character", "char"}, {"char", "char"},
            {"Short", "short"}, {"short", "short"}, {"Integer", "int"}, {"int", "int"},
  ...
  public TypeMapper() {
    ...
    // ----------------------------------------------------------------------
    /*
     * BIT "; TINYINT "; SMALLINT "; INTEGER "; BIGINT "; FLOAT "; REAL "; DOUBLE "; NUMERIC ";
     * DECIMAL "; CHAR "; VARCHAR "; LONGVARCHAR "; DATE "; TIME "; TIMESTAMP "; TIMESTAMPNS ";
     * TIMESTAMPTZ "; TIMESTAMPLTZ "; INTERVALYM "; INTERVALDS "; BINARY "; VARBINARY ";
     * LONGVARBINARY "; ROWID "; CURSOR "; BLOB "; CLOB "; BFILE "; STRUCT "; ARRAY "; REF
     * "; OPAQUE "; JAVA_STRUCT "; JAVA_OBJECT "; PLSQL_INDEX_TABLE "; BINARY_FLOAT "; BINARY_DOUBLE
