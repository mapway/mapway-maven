...
@Table("device_deviceAttr_view")
@Doc("device_deviceAttr_view(VIEW)")
public class DEVICE_DEVICEATTR_VIEWObj implements java.io.Serializable,com.google.gwt.user.client.rpc.IsSerializable,
  ...
  * 表VIEW名称. 
     */
  public static final String TBL_DEVICE_DEVICEATTR_VIEW="device_deviceAttr_view";
  public DEVICE_DEVICEATTR_VIEWObj() {
  }
  /**
   * 根据字段名称获取字段的值. 
   */
 ...
 * 属性名 attr_name
 */
  public static final Integer IDX_ATTR_NAME=14;
 /**
   * 字段attr_name 属性名
   */
	@Column("attr_name")
 ...
 * 属性值 value
 */
  public static final Integer IDX_VALUE=15;
 /**
   * 字段value 属性值
   */
	@Column("value")
 ...
 * 容器id container_id
 */
  public static final Integer IDX_CONTAINER_ID=16;
 /**
   * 字段container_id 容器id
   */
	@Column("container_id")
 ...
 * 设备id device_id
 */
  public static final Integer IDX_DEVICE_ID=17;
 /**
   * 字段device_id 设备id
   */
	@Column("device_id")
