 ...
 *  String container_name //CIM-名称<br/>
 *  String container_alias //<br/>
 * =========== 用于GWT模型 <br/>
 ...
 *  {@literal @ }UiField TextBoxEx txtContainer_name;<br/>
 *  {@literal @ }UiField TextBoxEx txtContainer_alias;<br/>
 * =========== 用于GWT UIBinder <br/>
 ...
 *  &lt;tr&gt;&lt;td&gt;CIM-名称&lt;/td&gt;&lt;td&gt;&ltc:TextBoxEx ui:field="txtContainer_name" &gt;&lt/c:TextBoxEx&gt;&lt;/td&gt; &lt;td&gt;&lt;/td&gt; &lt;/tr&gt;<br/>
 *  &lt;tr&gt;&lt;td&gt;&lt;/td&gt;&lt;td&gt;&ltc:TextBoxEx ui:field="txtContainer_alias" &gt;&lt/c:TextBoxEx&gt;&lt;/td&gt; &lt;td&gt;&lt;/td&gt; &lt;/tr&gt;<br/>
 * =========== 用于fromUI <br/>
 ...
 * data.setContainer_name(txtContainer_name.getValue());<br/>
 * data.setContainer_alias(txtContainer_alias.getValue());<br/>
 * =========== 用于toUI <br/>
 ...
 * txtContainer_name.setValue(obj.getContainer_name());<br/>
 * txtContainer_alias.setValue(obj.getContainer_alias());<br/>
 */

@Table("device_contianer_view")
@Doc("device_contianer_view(VIEW)")
public class DEVICE_CONTIANER_VIEWObj implements java.io.Serializable,com.google.gwt.user.client.rpc.IsSerializable,
  ...
  * 表VIEW名称. 
     */
  public static final String TBL_DEVICE_CONTIANER_VIEW="device_contianer_view";
  public DEVICE_CONTIANER_VIEWObj() {
  }
  /**
   * 根据字段名称获取字段的值. 
   */
  ...
  public Object getFieldValue(String fieldName,Integer fieldIndex) {
    if (fieldName != null && fieldName.length() > 0) {
      ...
      if (FLD_CONTAINER_NAME.equals(fieldName)) {
        return container_name;
      }
      if (FLD_CONTAINER_ALIAS.equals(fieldName)) {
        return container_alias;
      }
    } else if (fieldIndex != null && fieldIndex >= 0 && fieldIndex < 18) {
      if (fieldIndex == 0) {
        return device_id;
      }
      if (fieldIndex == 1) {
 ...
 * 设备路径 path
 */
  public static final Integer IDX_PATH=1;
 /**
   * 字段path 设备路径
   */
	@Column("path")
 ...
 * kks编码 kks
 */
  public static final Integer IDX_KKS=2;
 /**
   * 字段kks kks编码
   */
	@Column("kks")
 ...
 * 设备序列号 sno
 */
  public static final Integer IDX_SNO=3;
 /**
   * 字段sno 设备序列号
   */
	@Column("sno")
 ...
 * 状态 status
 */
  public static final Integer IDX_STATUS=5;
 /**
   * 字段status 状态
   */
	@Column("status")
 ...
 * 更信任ID uuser_id
 */
  public static final Integer IDX_UUSER_ID=8;
 /**
   * 字段uuser_id 更信任ID
   */
	@Column("uuser_id")
 ...
 * 创建人 cuser_id
 */
  public static final Integer IDX_CUSER_ID=9;
 /**
   * 字段cuser_id 创建人
   */
	@Column("cuser_id")
 ...
 * 更新时间 utime
 */
  public static final Integer IDX_UTIME=10;
 /**
   * 字段utime 更新时间
   */
	@Column("utime")
 ...
 * CIM-名称 name
 */
  public static final Integer IDX_NAME=12;
 /**
   * 字段name CIM-名称
   */
	@Column("name")
 ...
 * 容器CIMID con_cim_id
 */
  public static final Integer IDX_CON_CIM_ID=13;
 /**
 ...
 * CIMID cim_id
 */
  public static final Integer IDX_CIM_ID=14;
 /**
   * 字段cim_id CIMID
   */
	@Column("cim_id")
 ...
 * 容器id container_id
 */
  public static final Integer IDX_CONTAINER_ID=15;
 /**
   * 字段container_id 容器id
   */
	@Column("container_id")
  ...
  */
  ...
  /**
   * CIM-名称 container_name
 */
  public static final String FLD_CONTAINER_NAME="container_name";

  /**
 * CIM-名称 container_name
 */
  public static final Integer IDX_CONTAINER_NAME=16;
 /**
   * 字段container_name CIM-名称
   */
  ...
  /**
   * 返回字段container_name CIM-名称的值.
   * @return container_name  CIM-名称  varchar
  */
  ...
  /**
   * 设置字段container_name CIM-名称的值.
   * @param container_name  CIM-名称  varchar
   */
   ...
   *  container_alias
 */
  public static final String FLD_CONTAINER_ALIAS="container_alias";

  /**
 *  container_alias
 */
  public static final Integer IDX_CONTAINER_ALIAS=17;
 /**
   * 字段container_alias 
   */
	@Column("container_alias")
  @ApiField(value="",example="")
  private String container_alias;

  /**
   * 返回字段container_alias 的值.
   * @return container_alias    varchar
  */
  public String getContainer_alias() {
    return container_alias;
  }

  /**
   * 设置字段container_alias 的值.
   * @param container_alias    varchar
   */
  public void setContainer_alias(String container_alias) {
    this.container_alias=container_alias;
  }
